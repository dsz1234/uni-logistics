...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__7E7D57D",
    appName: "uni-logistics",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
const pages = [
  ...
  },
  {
    ...
    style: {
      navigationBarTitleText: "",
      navigationBarBackgroundColor: "#f05648",
      enablePullDownRefresh: false,
      navigationStyle: "custom"
    }
  },
  ...
  {
    path: "pages/login/components/account",
    style: {
      navigationBarTitleText: "",
      enablePullDownRefresh: false
    }
...
const b = true, k = "mp-weixin", T = S([]), P = k, A = S('{\n    "address": [\n        "127.0.0.1",\n        "172.20.2.74"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "local",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**",\n        "D:/软件/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), E = S('[{"provider":"aliyun","spaceName":"hanm2003","spaceId":"mp-776eaf33-a15a-4592-9717-1068e358b957","clientSecret":"fJZz4/7ftqf2GvlvOCfJaw==","endpoint":"https://api.next.bspapp.com"}]') || [];
let x = "";
try {
  x = "__UNI__7E7D57D";
} catch (e2) {
